...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> implements OnNoteItemClickListener{
    ...
    public void setOnClickListener(OnNoteItemClickListener listener){
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView moodImageView, moodImageView2, pictureExistsImageView, pictureImageView, weatherImageView, weatherImageView2;
        ImageView contentsTextView, contentsTextView2, locationTextView, locationTextView2, dateTextView, dateTextView2;
        ...
        public void setItem(Note item){
            ...
            String picturPath = item.getPicture();
            if ( picturPath != null && !picturPath.equals("")){
                pictureExistsImageView.setVisibility(View.VISIBLE);
                pictureImageView.setVisibility(View.VISIBLE);
                pictureImageView.setImageURI(Uri.parse("file://"+picturPath));
            }else{
            ...
            String weather = item.getWeahter();
