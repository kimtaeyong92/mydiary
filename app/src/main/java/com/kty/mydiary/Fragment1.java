...
public class Fragment1 extends Fragment {
    ...
    private void initUI(ViewGroup rootView){
        ...
        adapter.addItem(new Note(0, "0", "강남구 삼성동", "", "", "오늘 너무 행복해!", "0", "capture1.jpg","2월10일"));
        adapter.addItem(new Note(1, "1", "강남구 삼성동", "", "", "친구와 재미있게 놀았어", "0", "capture1.jpg","2월11일"));
        adapter.addItem(new Note(2, "0", "강남구 역삼동", "", "", "집에 왔는데 너무 피곤해 ㅠㅠㅠ", "0", null,"2월13일"));

        recyclerView.setAdapter(adapter);

        adapter.setOnClickListener(new OnNoteItemClickListener() {
            @Override
